...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return { title: { absolute: route.seoTitle }, description, alternates: { canonical: `/stories/${route.id}` }, openGraph: { title: route.seoTitle, description, url: `/stories/${route.id}`, type: "website", siteName: "Scene Korea", images: [{ url: `/stories/${route.id}/share-image`, width: 1200, height: 630, alt: `${route.course} · ${route.title}` }] }, twitter: { card: "summary_large_image", title: route.seoTitle, description, images: [`/stories/${route.id}/share-image`] } };
}
