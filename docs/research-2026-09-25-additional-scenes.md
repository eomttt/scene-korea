...
새 20코스 중 10개에 실제 장소 사진을 추가했다. 삽교호, 일월수목원, 쁘띠프랑스, 상주은모래비치, 목포근대역사관, 커먼그라운드, 수주팔봉 강변, 강남대로, 만휴정, 청라루의 사진이다. 전체 100코스 중 89개에 사진이 있고 11개에는 방문 순서 표지를 쓴다.
...
《낭만닥터 김사부》 돌담병원 건물은 실제 장소 사진과 상업 이용 조건을 함께 확인하지 못해 표지를 유지했다.
